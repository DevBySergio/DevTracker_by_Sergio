...
The [complete validation guide](docs/validation.md) documents the strict local gate, CI workflow, VSIX checks, and retained failure artifacts. The [Extension Host integration testing guide](docs/integration-testing.md) documents the isolated real-VS Code lifecycle and event suite used to validate activation, tracking, optional integrations, and shutdown persistence. The [webview regression testing guide](docs/webview-testing.md) documents the isolated browser harness, accessibility audits, and reviewed screenshot baselines. The [Trends dashboard guide](docs/dashboard-trends.md) explains ranges, fair comparisons, streaks, language evolution, accessible tables, and the view's privacy boundary. The [Projects dashboard guide](docs/dashboard-projects.md) documents project discovery, trend semantics, local preferences, and non-destructive history management.
